...
@SpringComponent
@Scope("prototype")
public class TestLoginForm extends ALoginForm {
     ...
     * @param fieldFactory
     */
    public TestLoginForm(@Qualifier(ACost.TAG_USE) ALoginService service, IAFieldFactory fieldFactory) {
        super(service);
    ...
    public Component createUsernameComponent() {
        ...
        nameField.setCaption("Usernamexyz");
