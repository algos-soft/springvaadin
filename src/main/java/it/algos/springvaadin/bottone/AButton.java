...
public class AButton extends Button {
     ...
     */
    void inizializza(ApplicationEventPublisher publisher, AButtonType type, ApplicationListener source, ApplicationListener target, AField sourceField, AEntity entityBean) {
