...
public enum TypeButton {
    ...
    annulla(Cost.BOT_ANNULLA, VaadinIcons.CLOSE, true, AButton.NORMAL_WIDTH, Cost.STYLE_GREEN),
    ...
    delete(Cost.BOT_DELETE, VaadinIcons.CLOSE, true, AButton.NORMAL_WIDTH, Cost.STYLE_RED),
    edit(Cost.BOT_EDIT, VaadinIcons.EDIT, false, AButton.NORMAL_WIDTH, Cost.STYLE_GREEN),
