...
@SpringView(name = ACost.VIEW_IND_FORM)
public class IndirizzoForm extends AForm {
     ...
     */
     public IndirizzoForm(@Lazy @Qualifier(ACost.TAG_IND) IAPresenter presenter, @Qualifier(ACost.BAR_FORM) IAToolbar toolbar) {
