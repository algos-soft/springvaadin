...
public class IndirizzoPresenter extends APresenter {
     ...
     */
    public IndirizzoPresenter(
                @Lazy @Qualifier(ACost.TAG_IND) IAService service,
                @Lazy @Qualifier(ACost.TAG_IND) IAList list,
                @Lazy @Qualifier(ACost.TAG_IND) IAForm form) {
