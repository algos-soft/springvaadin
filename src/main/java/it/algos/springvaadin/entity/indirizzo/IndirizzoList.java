...
@SpringView(name = ACost.VIEW_IND_LIST)
@AIView(roleTypeVisibility = EARoleType.admin)
public class IndirizzoList extends AList {
     ...
     */
    public static final String MENU_NAME = ACost.TAG_IND;
     ...
     */
    public IndirizzoList(
            @Lazy @Qualifier(ACost.TAG_IND) IAPresenter presenter,
