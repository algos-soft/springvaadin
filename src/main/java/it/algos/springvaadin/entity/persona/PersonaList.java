...
public class PersonaList extends AList {
     ...
     */
    public static final String MENU_NAME = ACost.TAG_PER;
     ...
     */
    public PersonaList(
            @Lazy @Qualifier(ACost.TAG_PER) IAPresenter presenter,
    ...
    protected void fixCaption(Class<? extends AEntity> entityClazz, List items) {
        ...
        if (login.isDeveloper()) {
            ...
            caption += "</br>NON usa direttamente la company";
            caption += "</br>La company però è facoltativa in modo che le sottoclassi (eventuali) possano usarla";
