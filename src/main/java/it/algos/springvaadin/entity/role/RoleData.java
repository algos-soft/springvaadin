...
public class RoleData extends AData {
    ...
    public void findOrCrea() {
        ...
        if (nessunRecordEsistente()) {
            ...
            log.warn("Algos - Creazione dati iniziali @EventListener ABoot.onApplicationEvent() -> ADataService.inizia() -> RoleData.findOrCrea(): " + numRec + " schede");
        } else {
            numRec = service.count();
    ...
    public void creaRuoli() {
        service.findOrCrea("ROLE_DEVELOPER");
        service.findOrCrea("ROLE_ADMIN");
        service.findOrCrea("ROLE_USER");
        service.findOrCrea("ROLE_GUEST");
    }// end of method
