 ...
 */
@SpringView(name = Cost.TAG_ROL)
public class RoleNavView extends AlgosNavView {


    //--nome usato da SpringNavigator e dal Menu per selezionare questa vista
    public static final String VIEW_NAME = Cost.TAG_ROL;
     ...
     */
    public RoleNavView(@Qualifier(Cost.TAG_ROL) AlgosPresenterImpl presenter) {
        super(presenter);
